...
# python3 ./allcommitsmensajev2.py -u <user> -d <directory> -r <repo> -n <number of commits>
#
...
def main():
  ...
  # Reference location for the .gitignore file (replace with your actual path) C:\D\GIT_Down_All_Commits
  reference_gitignore_path = "C:\D\GIT_Down_All_Commits\.gitignore"
  ...
  commitsLink = "https://api.github.com/repos/{0}/{1}/commits?page=4&per_page=25".format(githubUser, currentRepo)
  ...
  for commit in commits:
    ...
    if not listOnly:
      ...
      # Check if the reference .gitignore file exists
      if os.path.exists(reference_gitignore_path):
            # print('Copiando ignored ...')
            # Copy the reference .gitignore to the subdirectory
            shutil.copy(reference_gitignore_path, os.path.join(subdir, ".gitignore"))
            # print('Copiado')
      # else:
      #  print('ignored no encontrado')
