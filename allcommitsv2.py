...
def main():
  ...
  commitsLink = "https://api.github.com/repos/{0}/{1}/commits?page=2&per_page=100".format(githubUser, currentRepo)
  ...
  # 2024-07-16 el token no se usa por el momento
  # token = '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'
  # repoLink = "https://github.com/{0}:{1}/{2}.git".format(githubUser, token, currentRepo)
